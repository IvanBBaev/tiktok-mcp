// tiktok-mcp-ai docs — small progressive-enhancement script, no dependencies.
(function () {
  "use strict";
  ...
  if (clientConfig) {
    var CONFIGS = {
      ...
      vscode: {
        path: ".vscode/mcp.json  (or install the TikTok MCP extension — zero-config)",
        json:
          '{\n  "servers": {\n    "tiktok": {\n      "command": "npx",\n      "args": ["-y", "tiktok-mcp-ai"],\n      "type": "stdio",\n      "env": {\n        "TT_CLIENT_KEY": "your_client_key",\n        "TT_CLIENT_SECRET": "your_client_secret"\n      }\n    }\n  }\n}',
      },
      cursor: {
  ...
  (function () {
    ...
    var SCENARIOS = [
      {
        prompt: "Show my 4 latest videos with their view counts.",
        kind: "read",
        tool: "tiktok_list_videos",
        table: "· video",
        summary: "4 videos (newest first)",
        rows: [
          { left: "Morning studio routine ☕", right: "48.2K views", rc: "#5fb1ff" },
          { left: "3 editing tricks in 30s", right: "126K views", rc: "#5fb1ff" },
          { left: "Behind the scenes", right: "22.4K views", rc: "#5fb1ff" },
          { left: "Q&A · my camera gear", right: "9.7K views", rc: "#5fb1ff" },
        ],
      },
      {
        prompt: "Post my new demo.mp4 as public — preview it first.",
        kind: "write",
        tool: "tiktok_post_video",
        table: "· plan",
        summary: "Preview ready — plan_id issued, nothing posted yet",
        rows: [
          { left: "action", right: "DIRECT_POST video", rc: "#febc2e" },
          { left: "privacy_level", right: "PUBLIC_TO_EVERYONE", rc: "#5fb1ff" },
          { left: "plan_id", right: "plan_a1b2…9f", rc: "#00f2ea" },
          { left: "status", right: "awaiting your confirm", rc: "#febc2e" },
        ],
      },
      {
        prompt: "What's my current follower count and bio?",
        kind: "read",
        tool: "tiktok_get_user_info",
        table: "· user",
        summary: "profile fetched (user.info.basic + profile)",
        rows: [
          { left: "display_name", right: "Studio Ivan", rc: "#9aa8a0" },
          { left: "followers", right: "18,204", rc: "#5fb1ff" },
          { left: "likes", right: "342.1K", rc: "#5fb1ff" },
          { left: "videos", right: "87", rc: "#9aa8a0" },
        ],
      },
    ];
